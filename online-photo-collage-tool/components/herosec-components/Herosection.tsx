...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="container">
      <div className="hero-section h-screen flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="right-hero-section">
          <Image className=" drop-shadow-orange  backdrop-blur-0 " src={heroSection.image} alt="Hero Image" />
        </div>
      </div>
    </section>
  );
